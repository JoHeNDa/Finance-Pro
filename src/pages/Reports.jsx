      ...
      <div className="rp-filter-card">
        <div className="rp-filter-header">
          ...
          <div className="rp-preset-buttons">
            <button className="rp-preset-btn" onClick={() => setPresetDateRange('today')}>Today</button>
            <button className="rp-preset-btn" onClick={() => setPresetDateRange('week')}>This Week</button>
            <button className="rp-preset-btn" onClick={() => setPresetDateRange('month')}>This Month</button>
            <button className="rp-preset-btn" onClick={() => setPresetDateRange('year')}>This Year</button>
            <button className="rp-preset-btn" onClick={() => setPresetDateRange('all')}>All Time</button>
          </div>
        </div>
